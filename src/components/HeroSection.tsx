...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-transparent overflow-hidden">
      {/* Only keep SVG overlays if needed */}
      <SVGBackground />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className={`text-left transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-12 opacity-0'}`}> 
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-lg">
              Unlock your full potential with our expert trainers, cutting-edge equipment, and supportive community. Your journey to a healthier you starts here.
            </p>
            
            <div className="flex flex-wrap gap-4 mb-8">
              <Button
                className="bg-gradient-to-r from-white to-gray-400 hover:from-gray-200 hover:to-gray-500 text-black px-6 py-6 text-lg group transition-all duration-300 shadow-lg shadow-white/20"
              ...
              <Button
                variant="outline"
                className="border-white/20 text-white hover:bg-white/10 px-6 py-6 text-lg backdrop-blur-sm"
                onClick={() => {
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-8">
              <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm border border-white/10">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-gray-200 font-medium">Active Members</p>
                </div>
              ...
              <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm border border-white/10">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-gray-200 font-medium">Equipment</p>
                </div>
                <p className="text-2xl font-bold text-white">200+</p>
              </div>
              
              <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm border border-white/10 md:col-span-1 col-span-2">
                <div className="flex items-center gap-2 mb-2">
                  <Activity className="text-white w-5 h-5" />
                  <p className="text-gray-200 font-medium">Classes Weekly</p>
                </div>
            ...
            <div className="relative w-full aspect-square max-w-lg">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute -top-4 -right-4 p-4 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 shadow-lg z-20 transform rotate-3 animate-float-slow">
                  ...
                  <div className="absolute -bottom-4 -left-4 p-4 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 shadow-lg z-20 transform -rotate-3 animate-float-slow animation-delay-1000">
                    <div className="flex items-center gap-2">
                      <div className="w-4 h-4 rounded-full bg-white"></div>
                      <p className="text-white font-medium">Personal Training</p>
                    </div>
                  </div>
                </div>
              </div>
