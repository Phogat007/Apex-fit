...
const classes = [
  {
    id: 1,
    title: "HIIT Training",
    image: "https://images.unsplash.com/photo-1574680178050-55c6a6a96e0a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
    category: "cardio",
    duration: "45 min",
  ...
  },
  {
    id: 2,
    title: "Power Yoga",
    image: "https://images.unsplash.com/photo-1575052814086-f385e2e2ad1b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
    category: "yoga",
    duration: "60 min",
    trainer: "Sarah Chen",
    maxParticipants: 15,
  ...
  },
  {
    id: 3,
    title: "Weightlifting",
    image: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
    category: "strength",
    duration: "50 min",
    trainer: "Mike Torres",
    maxParticipants: 12,
  ...
  },
  {
    id: 4,
    title: "Spinning",
    image: "https://images.unsplash.com/photo-1594737625785-a6cbdabd333c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
    category: "cardio",
    duration: "40 min",
  ...
  },
  {
    id: 6,
    title: "CrossFit",
    image: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80",
    category: "strength",
    duration: "60 min",
    trainer: "Jessica Allen",
    maxParticipants: 15,
...
const ClassesSection = () => {
  ...
  const filteredClasses = activeTab === "all" 
    ? classes 
    : classes.filter(cls => cls.category === activeTab);
    ...
    <section id="classes" className="relative min-h-screen flex items-center justify-center bg-transparent overflow-hidden mt-24">
      ...
      <div className="container py-16 mx-auto px-4 z-10 lg:py-0">
        ...
        <Tabs defaultValue="all" className="w-full" onValueChange={setActiveTab}>
          <div className={`flex justify-center mb-12 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
          ...
          <TabsContent value={activeTab} className="mt-0">
            <div className={`grid sm:grid-cols-2 lg:grid-cols-3 gap-8 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
              {filteredClasses.map((cls) => (
                <div 
                  key={cls.id} 
                  className="bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden border border-white/10 hover:bg-white/20 transition-all duration-300 group"
                >
                  <div className="relative h-60 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <Badge className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white text-xs uppercase font-semibold border border-white/20">
                        {cls.category}
                      </Badge>
                    </div>
                  </div>
                  <div className="p-6">
                    ...
                    <div className="space-y-2 mb-6">
                      ...
                      <div className="flex items-center text-gray-300">
                        ...
                        <span className="text-sm">Max {cls.maxParticipants} participants</span>
                      </div>
                      <div className="flex items-center text-gray-300">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Button 
                        size="sm" 
                        variant="ghost" 
                        className="text-white hover:text-white/80 p-3 flex items-center group"
